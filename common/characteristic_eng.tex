...
{\scientifictasks}:
\begin{enumerate}
  \item Investigate vulnerability of the SPD used in SCW~QKD to blinding.  
  ...
  \item Investigate a measurement-device independent QKD protocol based on multimode weak coherent states used in SCW~QKD. 
\end{enumerate}
