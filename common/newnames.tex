...
\newcommand{\validityTXT}{Reliability and the validity}
% или чаще используют просто
\newcommand{\statementsTXT}{Scientific statements}
\newcommand{\influenceTXT}{Практическая значимость}
\newcommand{\importanceTXT}{Practical importance}
...
\newcommand{\approbationTXT}{Approbation.} 
\newcommand{\implementationTXT}{Implementation of the obtained results.}
\newcommand{\contributionTXT}{Личный вклад.}
\newcommand{\publicationsTXT}{Публикации.}
\newcommand{\refsTXT}{Publications.}
