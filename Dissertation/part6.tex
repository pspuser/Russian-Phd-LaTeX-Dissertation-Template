\chapter{Оформление различных элементов} \label{ch:ch6}

\section{Форматирование текста} \label{sec:ch6/sec1}

Мы можем сделать \textbf{жирный текст} и \textit{курсив}.

\section{Ссылки} \label{sec:ch6/sec2}
...
\subsection{Ненумерованные одиночные формулы} \label{subsec:ch6/sec3/sub1}
...
\subsection{Ненумерованные многострочные формулы} \label{subsec:ch6/sec3/sub2}
...
\subsection{Нумерованные формулы} \label{subsec:ch6/sec3/sub3}
